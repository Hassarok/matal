...
/** Kurdish — Kurmanji (LTR, Latin script). Partial — falls back to English. */
export const kmr: PartialTranslation = {
  brand: {
    tagline: 'Bilîze. Fêr bibe. Pêşbaziyê bike.',
  },
  hero: {
    badge: 'Qonaxa 1 · Bingeh amade ye',
    title: 'Cihê ku her quiz metelokek e ku were çareserkirin',
    subtitle:
